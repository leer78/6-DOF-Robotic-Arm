...
When run as a script (__main__):
  Performs full symbolic derivation using sympy, prints all transforms
  and runs a numeric FK verification pipeline.

When imported as a module:
  Exports DH_PARAMS, GEOM_PARAMS, rpy_to_matrix(), matrix_to_rpy().
  No sympy dependency — only standard-library math is needed.
...
# ============================================================================
# NUMERIC CONSTANTS  (single source of truth — importable without sympy)
# ============================================================================

# DH link parameters (mm)
DH_PARAMS = {
    "d1": 70.0,       # base height
    "a2": 278.0,      # upper arm length
    "a3": 64.4,       # link 3 length
    "d4": 165.05,     # wrist offset (joint 4 z-offset)
    "d6": 78.65,      # tool offset (wrist center to gripper tip)
}

# Geometric IK parameters (mapped from DH for the position solver)
#   l1 = base height to shoulder (= d1)
#   l2 = upper arm length (= a2)
#   l4 = elbow offset perpendicular (= a3)
#   l5 = elbow offset axial (= d4)
GEOM_PARAMS = {
    "l1": 70.0,       # = d1
    "l2": 278.0,      # = a2
    "l4": 64.4,       # = a3
...
# ============================================================================
# NUMERIC UTILITY FUNCTIONS  (importable without sympy)
# ============================================================================
...
# ============================================================================
# SYMBOLIC DERIVATION  (only runs when executed as a script)
# ============================================================================
